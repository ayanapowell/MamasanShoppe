...
var e=this;null!==e.$dots&&(e.$dots.find("li").removeClass("slick-active").attr("aria-hidden","true"),e.$dots.find("li").eq(Math.floor(e.currentSlide/e.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},t.prototype.visibility=function(){var e=this;e.options.autoplay&&(document[e.hidden]?e.interrupted=!0:e.interrupted=!1)},e.fn.slick=function(){var e,n,i=this,o=arguments[0],r=Array.prototype.slice.call(arguments,1),s=i.length;for(e=0;e<s;e++)if("object"==typeof o||"undefined"==typeof o?i[e].slick=new t(i[e],o):n=i[e].slick[o].apply(i[e].slick,r),"undefined"!=typeof n)return n;return i}});var app=app||{},win=$(window);!function(e){app.carousel={initializeSlider:function(){e(".my-carousel").slick({slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:3e3,dots:!0,arrows:!1,appendDots:e(".arrows")})},init:function(){app.carousel.els={carousel:e(".my-carousel")},app.carousel.initializeSlider()}},jQuery(document).ready(function(){app.carousel.init(),e("body").css({visibility:"visible"})})}(jQuery);var app=app||{};!function(e){app.components={logWhatsInHere:function(){},alertWhatsInHere:function(){},showVideos:function(){app.components.els.video.addClass("show")},init:function(){app.components.els={calendar:e("#calendar"),video:e(".video")},app.components.logWhatsInHere(),app.components.alertWhatsInHere(),app.components.showVideos()}},jQuery(document).ready(function(){app.components.init()})}(jQuery);var app=app||{};!function(e){app.responsiveNav={checkWindowWidth:function(){window.innerWidth<768?(app.responsiveNav.els.menuIcon.removeClass("hidden"),app.responsiveNav.els.navItems.addClass("hidden")):window.innerWidth>768&&(app.responsiveNav.els.navItems.removeClass("hidden"),app.responsiveNav.els.menuIcon.addClass("hidden"))},watchForWindowChanges:function(){e(window).resize(function(){app.responsiveNav.checkWindowWidth()})},responsiveNavigation:function(){e("#menu").click(function(){app.responsiveNav.els.menuIcon.addClass("hidden"),setTimeout(function(){e(".overlays").css({opacity:"0.8"})},80),e("#close-button").show(),e("#responsive-nav").removeClass("hidden-nav")}),e("#close-button").click(function(){e(this).hide(),setTimeout(function(){app.responsiveNav.els.menuIcon.removeClass("hidden")},400),e(".overlays").css({opacity:"0"}),e("#menu").show(),e("#responsive-nav").addClass("hidden-nav")})},init:function(){app.responsiveNav.els={navItems:e("#nav .nav-item"),responsiveNav:e("#responsive-nav"),menuIcon:e("#menu")},app.responsiveNav.checkWindowWidth(),app.responsiveNav.watchForWindowChanges(),app.responsiveNav.responsiveNavigation()}},jQuery(document).ready(function(){app.responsiveNav.init()})}(jQuery);var app=app||{};!function(e){app.home={homeSpecificFunction:function(){console.log("I'm the homepage")},callFunctionFromComponentsFile:function(){app.components.alertWhatsInHere()},init:function(){app.home.els={heroImage:e("#hero")},app.home.homeSpecificFunction(),app.home.callFunctionFromComponentsFile()}},jQuery(document).ready(function(){e("body").hasClass("home")&&app.home.init()})}(jQuery);